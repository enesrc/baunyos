  ...
  return (
    <a
      ...
      className="
        ...
        /* HOVER: Instagram'ın gerçek renk geçişi (Vibrant Gradient) */
        /* background-clip: border-box ile tüm alanı kaplar */
        hover:bg-[radial-gradient(circle_at_bottom_left,#feda3e_0%,#f97316_30%,#d62976_60%,#962fbf_85%,#4f5bd5_100%)]
        hover:text-white 
        hover:shadow-lg
      "
    >
